...
public class WebServerServletResponse implements HttpServletResponse {
    ...
    public PrintWriter getWriter() throws IOException {
        /*888*/
        OutputStreamWriter w = new OutputStreamWriter(webServerOutputStream, this.getCharacterEncoding());
